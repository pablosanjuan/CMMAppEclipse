...
public class Mision3 extends Activity implements OnClickListener {
	...
	private void validar_m3_101() {
		if (prefs.getBoolean("m3_101", false)){
        	txResult.setText("Así como recoges las huellas de la historia, nuestros personajes y sus familias dejan un legado histórico, con estos símbolos reconoces fácilmente a las familias");
        }
	}
	private void validar_m3_102() {
		if (prefs.getBoolean("m3_102", false)) {
        	txResult.setText("A parte de sus vidas públicas, también tenían espacio para recordar a sus parejas, busca las piezas que representan a José María Obando y su Querida Dolores Espinoza");
		}
	}
